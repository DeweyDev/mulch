...
class GUIDialog : public wxDialog
{
    ...
    public:
        GUIDialog( wxWindow* parent, int id = wxID_ANY, wxString title = wxT("mulchGUI"), wxPoint pos = wxDefaultPosition, wxSize size = wxDefaultSize, int style = wxDEFAULT_DIALOG_STYLE );
